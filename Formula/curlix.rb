...
#
# This lives in the curlix tap repo (curlix-io/homebrew-cli) as Formula/curlix.rb.
...
class Curlix < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "a66f0099d909d1c97b673db658f871632926d28437b397b0f1e03cac09038a27"
    end
  ...
  on_linux do
    on_arm do
      ...
      url "https://github.com/curlix-io/homebrew-cli/releases/download/cli-v1.2.3/curlix-1.2.3-linux-arm64.tar.gz"
      sha256 "92f21b44f8587f56d544373594f948ea0d84824969b153d2be8ffeabe397e035"
    end
    on_intel do
      url "https://github.com/curlix-io/homebrew-cli/releases/download/cli-v1.2.3/curlix-1.2.3-linux-x86_64.tar.gz"
